...
export default function App({route, navigation}){
    ...
    const name = "Ahsan Iqbal"
    const picture = "https://firebasestorage.googleapis.com/v0/b/se-project-81a89.appspot.com/o/Ellipse%208.png?alt=media&token=f625906e-6534-4ceb-af51-302d58abdc52"
    const processPress = () => {
