    ...
    render() {
        return (
            <ImageBackground source={require('../images/SPdashboard.png')} style={styles.backgroundImage}>
                <Text style={{ position: 'absolute', textAlign: 'center', fontStyle: 'normal', fontWeight: 'bold', top: 30, left: 50, fontSize: 25, color: '#FFFFFF' }}>Reviews</Text>
                <Text style={{ position: 'absolute', textAlign: 'center', fontStyle: 'normal', fontWeight: 'bold', top: 270, left: 15, fontSize: 18, color: '#000000' }}>You have not been given any reviews yet!</Text>
                <View style={{
                    flexDirection: 'row',
                    marginLeft: 107,
                    marginTop: 560,
